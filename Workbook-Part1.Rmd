...
The following video will provide an introduction to Retail Catchments.
...
So you can see a slightly larger catchment for 6am on a sunday morning in comparison to rush hour on a Friday evening. It is sometimes useful therefore to specify the time/day you want in the hereR API.
